...
let AvatarJobs = JSQMessagesAvatarImageFactory().avatarImage(withUserInitials: "JO", backgroundColor: UIColor.blue, textColor: UIColor.white, font: UIFont.systemFont(ofSize: 12))
...
// photo message
let photoItem = JSQPhotoMediaItem(image: UIImage(named: "success-baby"))
...
//    conversation = [message, message2,message3, message4, message5, photoMessage, audioMessage]
    conversation = [message, message2,message3, message4, message5, photoMessage]
    return conversation
}

func makeNormalConversation() -> [JSQMessage] {
//    conversation = [message6, message7, message8, message9, photoMessage, audioMessage]
    conversation = [message6, message7, message8, message9, photoMessage]
    return conversation
}
