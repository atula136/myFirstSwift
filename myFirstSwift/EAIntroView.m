...
- (UIView *)viewForPage:(EAIntroPage *)page atXIndex:(CGFloat)xIndex {
    ...
    if(page.titleIconView) {
        ...
        titleImageView.frame = pageView.bounds;
...
- (void)buildFooterView {
    ...
    if (self.skipButton && !self.skipButton.hidden) {
        ...
        */
        [self.footerConstraints addObject:[NSLayoutConstraint constraintWithItem:_skipButton attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeCenterX multiplier:1 constant:0]];
        [self.footerConstraints addObject:[NSLayoutConstraint constraintWithItem:_skipButton attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeWidth multiplier:0.798 constant:0]];
        ...
        if(self.skipButtonY == EA_EMPTY_PROPERTY) {
            ...
            [self.footerConstraints addObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[skipButton(40)]-skipButtonBottomPadding-|" options:NSLayoutFormatAlignAllCenterX metrics:metrics views:views]];//custom change
        }
    }
