...
//    @IBOutlet fileprivate weak var heightConstraint: NSLayoutConstraint!
    ...
    class func create() -> ContentViewController {
        let mainStoryboard = UIStoryboard(name: "Segmentio", bundle: nil)
...
extension ContentViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "SegmentioContentCell", for: indexPath) as! ExampleTableViewCell
